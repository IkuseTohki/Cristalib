...
from .interfaces import IBookEditDialog


class BookEditDialog(QDialog, Ui_BookEditDialog, IBookEditDialog):
    """書籍情報を編集するためのダイアログ。"""
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.original_book_id = None  # 初期化
    ...
    def display_book_data(self, book: Book):
        ...
        """
        self.original_book_id = book.id  # IDを保存
